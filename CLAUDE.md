...
| v12 | 災害復旧 + データ保護 (AWS Backup, RDS Read Replica, S3 CRR, S3 Versioning/Lifecycle, 読み書き分離) | 完了 |
| v13 | セキュリティ監視 + コンプライアンス (CloudTrail, GuardDuty, AWS Config, Security Hub, EventBridge→SNS) | 進行中 |
